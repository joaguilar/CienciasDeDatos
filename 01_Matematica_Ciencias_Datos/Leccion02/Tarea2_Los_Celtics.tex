...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{ggboxplot}\NormalTok{(algodon_stacked, }\DataTypeTok{x=}\StringTok{"ind"}\NormalTok{, }\DataTypeTok{y =} \StringTok{"values"}\NormalTok{, }\DataTypeTok{color =} \StringTok{"ind"}\NormalTok{, }\DataTypeTok{order =} \KeywordTok{c}\NormalTok{(}\StringTok{"Porc_15"}\NormalTok{, }\StringTok{"Porc_20"}\NormalTok{, }\StringTok{"Porc_25"}\NormalTok{, }\StringTok{"Porc_30"}\NormalTok{, }\StringTok{"Porc_35"}\NormalTok{), }\DataTypeTok{ylab =} \StringTok{"libra/pulg^2"}\NormalTok{, }\DataTypeTok{xlab =} \StringTok{"% de Algodón")}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{ggline}\NormalTok{(algodon_stacked, }\DataTypeTok{x=} \StringTok{"ind"}\NormalTok{, }\DataTypeTok{y =} \StringTok{"values"}\NormalTok{, }\DataTypeTok{add =} \KeywordTok{c}\NormalTok{(}\StringTok{"mean_se"}\NormalTok{, }\StringTok{"jitter"}\NormalTok{), }\DataTypeTok{order =} \KeywordTok{c}\NormalTok{(}\StringTok{"Porc_15"}\NormalTok{, }\StringTok{"Porc_20"}\NormalTok{, }\StringTok{"Porc_25"}\NormalTok{, }\StringTok{"Porc_30"}\NormalTok{, }\StringTok{"Porc_35"}\NormalTok{), }\DataTypeTok{ylab =} \StringTok{"libra/pulg^2"}\NormalTok{, }\DataTypeTok{xlab =} \StringTok{"% de Algodón")}
\end{Highlighting}
\end{Shaded}
