...
ggboxplot(algodon_stacked, x="ind", y = "values", color = "ind", order = c("Porc_15", "Porc_20", "Porc_25", "Porc_30", "Porc_35"), ylab = "libra/pulg^2", xlab = "% de Algodón", title="Distribución de los datos en los diferentes tratamientos")
```

```{r, fig.width=6, fig.height=3, echo=FALSE, message=FALSE}
ggline(algodon_stacked, x= "ind", y = "values", group = 1, color = "ind", add = c("mean_se", "jitter"), order = c("Porc_15", "Porc_20", "Porc_25", "Porc_30", "Porc_35"), ylab = "libra/pulg^2", xlab = "% de Algodón", title = "Media y cuadrados de los errores por tratamiento")
```
...
Adicionalmente, ANOVA utiliza los _grados de libertad_. En el caso de variables categóricas, como en este caso, para las medias se calcula como uno menos que el numero de niveles $DF_k=k-1$. En el caso del error, se calcula como el número de observaciones menos el número de niveles (o grupos) usados $DF_n=n-k$.
