...
```
De estos datos podemos crear algunos campos adicionales que nos pueden ayudar a la hora de manipularlos. Para inciar, vamos a crear estos dos campos adicionales:

| Campo  | Descripción | Tipo  |
|---|---|---|
| Total | Total de la compra del producto | Numérico |
| InvoiceDay | Fecha de la compra sin la hora para sumarizar por día | Fecha |
Ademas de realizar las siguientes conversiones:
...
Podemos analizar las compras de un cliente de estos, por ejemplo, el 14646. 
