...
retail_limpio$CustomerID<-as.numeric()
...
fviz_nbclust(retail_limpio,pam,method = 'silhouette',k.max = 10)

# cálculo del valor óptimo de k usando el método del codo
fviz_nbclust(retail_limpio,pam,method = 'wss',k.max = 10)

# cálculo del valor óptimo de k usando la estadística gap
fviz_nbclust(retail_limpio,pam,method = 'gap_stat',k.max = 10)
