...
Para el proceso de limpieza de datos el primer paso es la limpieza de la columna ingresos a la cual se le remueve el keyword "est" así como se reemplazan los signos de dólar.
...
datos$Anno <- as.factor(datos$Anno)
datos$Ingresos <- as.double(datos$Ingresos)
str(datos)
head(datos)
```
