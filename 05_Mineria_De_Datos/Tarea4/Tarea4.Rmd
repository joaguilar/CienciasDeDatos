...
resultado_medoids %>%
  arrange((resultado_medoids$clusters_kmedoids.cluster))
```
...
Para determinar el número de clusteres optimo se analizan los 3 métodos vistos en clase, y luego de analizar los diferentes resultados, así como los resultados del número optimo para el algoritmo de kmedoids, se propone hacer uso de un k=4 a fin de comparar los resultados de los modelos.
...
resultado_kmeans %>%
  arrange((resultado_kmeans$clusters.cluster))
```
...
resultados_kmd %>%
  select('Franquicia','Ingresos', 'Anno','clusteres_medoids','clusteres_kmeans') %>%
